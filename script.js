...
function setupModal() {
    ...
    if (heroAddButton) {
        ...
        heroAddButton.addEventListener("click", function (event) {
...
function saveBook() {
    ...
    let progress = Number(
        progressInput ? progressInput.value : 0
    );
...
function importLibrary(event) {
    ...
    reader.onload = function () {
        ...
        try {
            ...
            books =
                imported.map(function (book, index) {
